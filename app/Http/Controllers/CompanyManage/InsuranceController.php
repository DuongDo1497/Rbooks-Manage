...
class InsuranceController extends Controller
{
    public function __construct(InsuranceService $service)
    {
        ...
        $this->setViewPrefix('user-employees.insurances.');
        $this->setRoutePrefix('insurances-');
        $this->view->setHeading('home.Thông tin bảo hiểm xã hội');
    }
    ...
    public function index(Request $request)
    {
        ...
        $this->view->collections = $this->main_service->getInsurances($employeeid_decrypt);
        $this->view->setSubHeading('home.Quá trình đóng bảo hiểm xã hội');
