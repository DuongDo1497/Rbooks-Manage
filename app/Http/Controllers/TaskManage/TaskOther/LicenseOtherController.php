...
use RBooks\Services\LicenseOtherService;
use RBooks\Services\EmployeeService;
use RBooks\Repositories\TaskChildRepository;
use RBooks\Repositories\TaskOneRepository;
use \Auth;

class LicenseOtherController extends Controller
{
    public function __construct(LicenseOtherService $service)
    {
        parent::__construct($service);

        $this->setViewPrefix('task-manage.taskothers.license.');
    ...
    {   
        ...
        $this->view->collections = $this->main_service->getAll()->where('module_id', 14)->where('module_type', 10);
        // Setup title
