...
use RBooks\Services\LayoutOtherService;
use RBooks\Services\EmployeeService;
use RBooks\Repositories\TaskChildRepository;
use RBooks\Repositories\TaskOneRepository;
use \Auth;

class LayoutOtherController extends Controller
{
    public function __construct(LayoutOtherService $service)
    {
        parent::__construct($service);

        $this->setViewPrefix('task-manage.taskothers.layout.');
    ...
    {   
        ...
        $this->view->collections = $this->main_service->getAll()->where('module_id', 12)->where('module_type', 10);
        // Setup title
