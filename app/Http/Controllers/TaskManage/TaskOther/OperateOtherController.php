...
use RBooks\Services\OperateOtherService;
use RBooks\Services\EmployeeService;
use RBooks\Repositories\TaskChildRepository;
use RBooks\Repositories\TaskOneRepository;
use \Auth;

class OperateOtherController extends Controller
{
    public function __construct(OperateOtherService $service)
    {
        parent::__construct($service);

        $this->setViewPrefix('task-manage.taskothers.operate.');
    ...
    {   
        ...
        $this->view->collections = $this->main_service->getAll()->where('module_id', 9)->where('module_type', 10);
        // Setup title
