...
use RBooks\Services\MktOtherService;
use RBooks\Services\EmployeeService;
use RBooks\Repositories\TaskChildRepository;
use RBooks\Repositories\TaskOneRepository;
use \Auth;

class MktOtherController extends Controller
{
    public function __construct(MktOtherService $service)
    {
        parent::__construct($service);

        $this->setViewPrefix('task-manage.taskothers.marketing.');
    ...
    {   
        ...
        $this->view->collections = $this->main_service->getAll()->where('module_id', 6)->where('module_type', 10);
        // Setup title
