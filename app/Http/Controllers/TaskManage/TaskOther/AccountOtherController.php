...
use RBooks\Services\AccountOtherService;
...
{
    public function __construct(AccountOtherService $service)
    {
        parent::__construct($service);

        $this->setViewPrefix('task-manage.taskothers.account.');
    ...
    {   
        ...
        $this->view->collections = $this->main_service->getAll()->where('module_id', 5)->where('module_type', 10);
        // Setup title
