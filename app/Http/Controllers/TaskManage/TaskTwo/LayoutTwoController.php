...
use RBooks\Services\LayoutTwoService;
use RBooks\Repositories\TaskWaitReceiveRepository;
use RBooks\Repositories\EmployeeRepository;
use App\Constants\NotificationMessage;
use \Auth;

class LayoutTwoController extends Controller
{
    public function __construct(LayoutTwoService $service)
    {
        ...
        $this->setViewPrefix('task-manage.tasktwos.layout.');
    ...
    {
        $this->view->collections = $this->main_service->getAll()->where('module_id', 12)->where('module_type', 2);
        // Setup title
