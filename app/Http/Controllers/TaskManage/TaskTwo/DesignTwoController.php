...
use RBooks\Services\DesignTwoService;
use RBooks\Repositories\TaskWaitReceiveRepository;
use RBooks\Repositories\EmployeeRepository;
use App\Constants\NotificationMessage;
use \Auth;

class DesignTwoController extends Controller
{
    public function __construct(DesignTwoService $service)
    {
        parent::__construct($service);

        $this->setViewPrefix('task-manage.tasktwos.design.');
    ...
    {   
        ...
        // $this->view->taskWaits = app(TaskWaitReceiveRepository::class)->get()->where('module_id', 3)->where('roman_numerals', 'XVIII');

        $this->view->collections = $this->main_service->getAll()->where('module_id', 3)->where('module_type', 2);
        // Setup title
