...
use RBooks\Services\TransTVTAService;
use RBooks\Repositories\EmployeeRepository;
use App\Http\Controllers\TaskManage\TaskOne\TaskOneController;
use \Auth;

class TransTVTAController extends Controller
{
    public function __construct(TransTVTAService $service)
    {
        parent::__construct($service);

        $this->setViewPrefix('task-manage.task_tv_ta.translate.');
    ...
    {   
        ...
        $this->view->collections = $this->main_service->getAll()->where('module_id', 11)->where('module_type', 20);
        // Setup title
