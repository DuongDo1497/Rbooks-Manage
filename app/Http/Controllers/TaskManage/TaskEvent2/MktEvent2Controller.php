...
class MktEvent2Controller extends Controller
{
    public function __construct(MktEvent2Service $service)
    {
        parent::__construct($service);

        $this->setViewPrefix('task-manage.task_event.marketing2.');
    ...
    {   
        ...
        $this->view->taskWaits = app(TaskWaitReceiveRepository::class)->get()->where('module_id', 6)->where('module_type', 14)->where('roman_numerals', 'IV');

        $this->view->collections = $this->main_service->getAll()->where('module_id', 6)->where('module_type', 14);
        // Setup title
