...
class SalesSachRbooksController extends Controller
{
    public function __construct(TaskOneService $service)
    {
        parent::__construct($service);

        $this->setViewPrefix('task-manage.task_sach_rbooks.sales.');
    ...
    {   
        ...
        $this->view->taskWaits = app(TaskWaitReceiveRepository::class)->get()->where('module_id', 8)->where('module_type', 16)->whereIn('roman_numerals', ['V', 'VI', 'XX']);

        $this->view->collections = $this->main_service->getAll()->where('module_id', 8)->where('module_type', 16);
        // Setup title
