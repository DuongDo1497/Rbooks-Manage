                        ...
                        <table width="100%">
                            <tbody>
                                <tr>
                                    ...
                                    <td width="60%">{{ $detai_employee->beginlabordate == NUll ? "" : date("d/m/Y", strtotime($detai_employee->beginlabordate)) }} - {{ $detai_employee->finishworkdate == NUll ? " " : date("d/m/Y", strtotime($detai_employee->finishworkdate)) }}</td>
                                </tr>
                                <tr>
