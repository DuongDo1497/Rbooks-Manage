...
<div class="row">
    <form role="form" action="{{ route('checkemployees-update', ['id' => $checkemployee->id]) }}?continue=false" method="post" id="frm">
        <div class="col-md-8">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="checktype_id" required>
                            ...
                            @foreach($checktypes->where('showtype', 1) as $checktype)
                                @if($checkemployee->checktype_id == $checktype->id)
                    ...
                    <div class="form-group from_start_box">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="date" class="form-control fromdate" name="fromdate" value="{{ $checkemployee->fromdate->toDateString() }}" required>
                    ...
                    <div class="form-group to_end_box">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="date" class="form-control todate" name="todate" value="{{ $checkemployee->todate->toDateString() }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control numday" step="0.01" name="numday" value="{{ $checkemployee->numday }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" rows="2" required>{{ $checkemployee->description }}</textarea>                        
        ...
        <div class="col-md-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <a href="{{ route('checkemployee-empl', [ 'parameter' => $employeeid ]) }}" class="btn btn-default btn-cancel" tabindex="10">Trở về</a>
                </div>
            </div>
        </div>
    </form>
