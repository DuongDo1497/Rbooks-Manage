<div class="box box-search">
    <form action="{{ route('careers-index') }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select id="searchFields" class="form-control select2" name="searchFields" data-minimum-results-for-search="Infinity">
                            ...
                            <option value="">{{ trans('home.Vị trí ứng tuyển') }}</option>
        ...
        <div class="box-footer text-right">
            ...
            <a href="{{ route('recruitments-index') }}" class="btn btn-primary btn-delete">{{ trans('home.Xóa form') }}</a>
        </div>
    </form>
</div>