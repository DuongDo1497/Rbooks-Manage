<div class="box box-search">
    <form action="{{ route('divisions-index') }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select id="searchFields" class="form-control select2" name="searchFields" data-minimum-results-for-search="Infinity">
                            <option value="id:like;code_divisions:like;name:like;">{{ trans('home.Tất cả') }}</option>
                            <option value="id:like;">{{ trans('home.ID') }}</option>
                            <option value="code_divisions:like;">{{ trans('home.Mã bộ phận') }}</option>
                            <option value="name:like;">{{ trans('home.Tên bộ phận') }}</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="box-footer text-right">
            ...
            <a href="{{ route('divisions-index') }}" class="btn btn-primary btn-delete">{{ trans('home.Xóa form') }}</a>
        </div>
    </form>
</div>