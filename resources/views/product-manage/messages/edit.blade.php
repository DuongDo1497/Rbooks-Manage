...
@endif
<div class="row">
    <form role="form" action="{{ route('messages-update', ['id' => $model->id]) }}?continue=true" method="post" id="messages-form">
        <div class="col-md-8">
            ...
            <div class="box box-primary box-control">
                ...
                <div class="box-body">
                    <div class="btn-group">
                        ...
                        <a href="{{ route('messages-index') }}" class="btn btn-default btn-cancel" tabindex="8">
