...
<script>
    $(function() {
        ...
        $('#chk-continue').on('ifChecked', function() {
            $('#importmanage-form').attr('action', '{{ route('warehouses-imports-store') }}?continue=true');
        });

        $('#chk-continue').on('ifUnchecked', function() {
            $('#importmanage-form').attr('action', '{{ route('warehouses-imports-store') }}');
        });
        ...
        $('#modal-product-add-btn').click(function() {
            ...
            table_row.append($('<td class="disc text-center"><input class="form-control" name="products[' + $('.search-code').val() + '][discount]" type="number" step="any" value="' + $('#modal-product-discount').val() + '"></td>'));
        ...
        // $("#ship_id").click(function(){
            
        //     if ($('#ship_id').val() == 'ship_agency_1') {
        //         // $('.ship-agency').addClass('show');
        //         $('.ship-agency').show();
        //     }else{
        //         // $('.ship-agency').removeClass('show');
        //         $('.ship-agency').hide();
        //     }
        // });
    });
