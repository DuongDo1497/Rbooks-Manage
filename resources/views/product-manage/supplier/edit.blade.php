    ...
    <div class="col-md-8">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Chỉnh sửa đối tác RB</h3>
            </div>
            <form  method="post" action="{{ route('suppliers-update', ['id' => $model->id ]) }}" role="form" id="supplier-form">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <label>Code</label>
                        <input type="text" class="form-control" placeholder="ID đối tác RB" name="code" tabindex="1" value="{{ $model->code }}">
                    </div>
                        <div class="form-group {{ ($errors->has('name')) ? ' has-error' : '' }}">
                            <label>Tên đối tác RB</label>
                            <input type="text" class="form-control" placeholder="Tên đối tác RB" name="name" tabindex="2" value="{{ $model->name }}">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" placeholder="{{ trans('home.Địa chỉ') }}" name="address" tabindex="4" value="{{ $model->address }}">
                        </div>
                        <div class="form-group col-md-6">
                            <div class="form-group">
