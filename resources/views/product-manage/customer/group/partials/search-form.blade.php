<div class="box box-search">
    <form action="{{ route('customers-groups-index') }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select id="searchFields" class="form-control select2" name="searchFields" data-minimum-results-for-search="Infinity">
                            <option value="name;code">{{ trans('home.Tất cả') }}</option>
                            <option value="name">{{ trans('home.Tên nhóm') }}</option>
                            <option value="code">{{ trans('home.Mã nhóm') }}</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="box-footer text-right">
            ...
            <a href="{{ route('customers-groups-index') }}" class="btn btn-primary btn-delete">{{ trans('home.Xóa form') }}</a>
        </div>
    </form>
</div>