<div class="box box-search">
    <form action="{{ route('promotions-index') }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select id="searchFields" class="form-control select2" name="searchFields" data-minimum-results-for-search="Infinity">
                            ...
                            <option value="">{{ trans('home.Tên khách hàng') }}</option>
                            <option value="">{{ trans('home.Email') }}</option>
                            <option value="">{{ trans('home.Số điện thoại') }}</option>
                            <option value="">{{ trans('home.Địa chỉ') }}</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="box-footer text-right">
            ...
            <a href="{{ route('promotions-index') }}" class="btn btn-primary btn-delete">{{ trans('home.Xóa form') }}</a>
        </div>
    </form>
</div>