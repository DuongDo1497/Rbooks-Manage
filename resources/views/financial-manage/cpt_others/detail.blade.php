...
<div class="row">
    ...
    <div class="col-md-3">
    	<div class="box box-primary">
            ...
            <div class="box-body">
                <a href="{{ route('cpt_khac-index') }}" class="btn btn-default btn-cancel" tabindex="10" style="width: 100%;">{{ trans('home.Trở về') }}</a>
            </div>
        </div>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a class="editPaySlip" data-toggle="modal" href="#getEdit" data-route="{{ route('cpt_khac_payslip-update', ['id' => $cptpaymentslip->id, 'idcostprice' => $detail->id]) }}?index=true" data-id="{{ $cptpaymentslip->id }}"><i class="fas fa-pencil-alt" style="margin-right: 10px;"></i> {{ trans('home.Chỉnh sửa') }}</a></li>
                                                <li><a href="javascript:void(0)" data-id="{{ $cptpaymentslip->id }}" class="btn-delete"><i class="fa fa-trash" aria-hidden="true"></i> {{ trans('home.Xóa') }}</a>
                                                    <form style="margin: 0;" name="form-delete-{{ $cptpaymentslip->id }}" method="post" action="{{ route('cpt_khac_payslip-delete', ['id' => $cptpaymentslip->id, 'idcostprice' => $detail->id]) }}">
                                                        {{ csrf_field() }}
                                                        {{ method_field('delete') }}
                                                    </form>
                                                </li>
...
@include('financial-manage.cpt_others.storePaySlip')
@include('financial-manage.cpt_others.editPaySlip')
