<div class="box-group clearfix">
    <div class="box box-default">
        <form action="{{ route('cpcn_khac-index') }}">
            ...
            <div class="box-footer text-right">
                ...
                <a href="{{ route('cpcn_khac-index') }}" class="btn btn-default">{{ trans('home.Xóa form') }}</a>
            </div>
        </form>
    </div>
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('home.Thống kê công nợ khác') }}</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <div class="row">
