...
@endif
<div class="row">
    <form role="form" action="{{ route('cpt_gvt-store') }}?continue=true" method="post" id="cpt_gvt-form" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control total-vat" placeholder="{{ trans('home.home.Nhập số tiền') }}" name="remaining_cost_vat">
                                    <span class="input-group-addon">VND</span>
                                </div>
                                @if($errors->has(''))<span class="help-block">{{ $errors->first('') }}</span>@endif
                            </div>
