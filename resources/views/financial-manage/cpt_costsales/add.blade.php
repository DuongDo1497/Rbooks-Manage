...
@endif
<div class="row">
    <form role="form" action="{{ route('cpt_qlbh-store') }}?continue=true" method="post" id="cpt_qlbh-form" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control total-vat" placeholder="Nhập số tiền" name="novat_cost">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control total-vat" placeholder="Nhập số tiền" name="vat_cost">
                                    <span class="input-group-addon">VND</span>
                                </div>
                                @if($errors->has(''))<span class="help-block">{{ $errors->first('') }}</span>@endif
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control total-vat" placeholder="Nhập số tiền" name="paided_cost_novat">
                                    <span class="input-group-addon">VND</span>
                                </div>
                                @if($errors->has(''))<span class="help-block">{{ $errors->first('') }}</span>@endif
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control total-vat" placeholder="Nhập số tiền" name="paided_cost_vat">
                                    <span class="input-group-addon">VND</span>
                                </div>
                                @if($errors->has(''))<span class="help-block">{{ $errors->first('') }}</span>@endif
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control total-vat" placeholder="Nhập số tiền" name="remaining_cost_novat">
                                    <span class="input-group-addon">VND</span>
                                </div>
                                @if($errors->has(''))<span class="help-block">{{ $errors->first('') }}</span>@endif
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control total-vat" placeholder="Nhập số tiền" name="remaining_cost_vat">
                                    <span class="input-group-addon">VND</span>
                                </div>
                                @if($errors->has(''))<span class="help-block">{{ $errors->first('') }}</span>@endif
                            </div>
