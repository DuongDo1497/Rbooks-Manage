<div class="box-group clearfix">
    <div class="box box-default">
        <form action="{{ route('cpcn_bh-index') }}">
            ...
            <div class="box-footer text-right">
                ...
                <a href="{{ route('cpcn_bh-index') }}" class="btn btn-default">{{ trans('home.Xóa form') }}</a>
            </div>
        </form>
    </div>
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('home.Thống kê công nợ quản lý doanh nghiệp') }}</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <div class="row">
