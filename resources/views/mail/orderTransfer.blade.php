	...
	<div class="content">
	    	...
	    	<article>
	    		<div>
	    			...
	    			<div style="text-align: justify;">
	    				RBooks.vn rất vui thông báo đơn hàng <b>#{{ $order->id }}</b> của quý khách đã được bàn giao thành công đến đối tác vận chuyển.
	    			</div>
	    		</div>
	    ...
	    <footer>
	    	<div style="padding-top: 20px;">
				<div style="text-align: justify;">
					<p>Hàng hóa luôn được RBooks đóng gói cẩn thận. Khi nhận hàng, quý khách vui lòng kiểm tra sản phẩm còn nguyên đai/nguyên kiện. Nếu phát hiện gói hàng có dấu hiệu bung tróc tem hay biến dạng, xin vui lòng liên hệ ngay với RBooks để được hỗ trợ.</p>

					<p>Qúy khách vui lòng giữ lại hóa đơn, hộp sản phẩm và phiếu bảo hành (nếu có) để đổi trả hàng hoặc bảo hành khi cần thiết.</p>

					<p style="margin-bottom: 0;">Quý khách vui lòng kiểm tra chính xác thông tin đơn hàng. Mọi thắc mắc, quý khách vui lòng liên hệ info@rbooks.vn, hoặc gọi số điện thoại <b>08 4966 4005</b> (8h-21h cả T7,CN) để được hỗ trợ tốt nhất từ nhân viên chăm sóc khách hàng.</p>
				</div>
