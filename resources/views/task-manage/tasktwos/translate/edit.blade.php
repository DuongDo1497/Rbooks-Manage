...
<div class="row">
    <form role="form" action="{{ route('task-update', ['id' => $taskTranslate->id]) }}?taskupdate=true" method="post" id="translate_ones-form">
        {{ csrf_field() }}
        {{ method_field('put') }}
        ...
        <div class="col-md-8">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label>Mô tả</label>
                        <textarea class="form-control" placeholder="Nhập mô tả" rows="4" name="note">{{ $taskTranslate->description }}</textarea>
                    </div>
                    <div class="form-group">
                        <label>Ghi chú</label>
...
<script>
    $(function() {
        $('.btn-save').click(function() {
            $('#translate_ones-form').submit();
        });

        $('#chk-continue').on('ifChecked', function() {
            $('#translate_ones-form').attr('action', '');
        });
