...
<div class="row">
    <form role="form" action="{{ route('task-update', ['id' => $taskLicense->id]) }}?taskupdate=true" method="post" id="design_ones-form">
        {{ csrf_field() }}
        {{ method_field('put') }}
        ...
        <div class="col-md-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <a href="{{ route('license_twos-index') }}" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
                </div>
            </div>
        </div>
    </form>
