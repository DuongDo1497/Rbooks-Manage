...
<form role="form" action="{{ route('design-assign-division-2', ['id' => $detailTask->id]) }}" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
		...
		<div class="col-md-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <select class="form-control select2" name="assign">
                            <option value="print1">Giao Task Leader In ấn 1</option>
                            <option value="sales1">Giao Task Leader Sales 1</option>
                            <option value="marketing2">Giao Task Leader Makerting 2</option>
                            <option value="it3">Giao Task Leader IT 3</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                ...
                <div class="box-body">
                    ...
                    <a href="{{ route('design_twos-index') }}" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
                </div>
            </div>
		</div>
