...
<form role="form" action="{{ route('translate-tv-ta-assign-division-1', ['id' => $detailTask->id]) }}?continue=true" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
		...
		<div class="col-md-4">
            <div class="box box-primary">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <select class="form-control select2" name="assign">
                                    <option value="trans_tvta2">Giao Task Leader Biên dịch 2</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box-body">
                    ...
                    <a href="{{ route('translate-tv-ta-index-1') }}" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
                </div>
            </div>
		</div>
