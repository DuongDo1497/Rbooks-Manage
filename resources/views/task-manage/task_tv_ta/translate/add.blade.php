<div class="modal fade" id="getFormAddTask" role="dialog">
    <form action="{{ route('translate-tv-ta-store-1') }}?index=true" enctype="multipart/form-data" method="POST">
        {{ csrf_field() }}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="{{ trans('home.Nhập loại dự án') }}" name="tasktype">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" placeholder="{{ trans('home.Nhập ghi chú') }}" rows="4" name="description"></textarea>
                    </div>
                </div>
