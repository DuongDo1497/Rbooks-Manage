...
<div class="row">
    <form role="form" action="{{ route('task-update', ['id' => $taskTranslate->id]) }}?taskupdate=true" method="post" id="translate-tv-ta-form">
        {{ csrf_field() }}
        {{ method_field('put') }}
...
<script>
    $(function() {
        $('.btn-save').click(function() {
            $('#translate-tv-ta-form').submit();
        });

        $('#chk-continue').on('ifChecked', function() {
            $('#translate-tv-ta-form').attr('action', '');
        });
