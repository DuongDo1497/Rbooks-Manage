...
<form role="form" action="{{ route('translate-tv-ta-rb-assign-division-2', ['id' => $detailTask->id]) }}" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
		...
		<div class="col-md-4">
            <div class="box box-primary">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <select class="form-control select2" name="assign">
                                    <option value="design_tvta1">Giao Task Leader Design 1</option>
                                    <option value="layout_tvta1">Giao Task Leader Dàn trang 1</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box-body">
                    ...
                    <a href="{{ route('translate-tv-ta-index-2') }}" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
                </div>
            </div>
		</div>
