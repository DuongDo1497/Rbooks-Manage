...
<div class="row">
    <form role="form" action="{{ route('task-update', ['id' => $taskTranslate->id]) }}?taskupdate=true" method="post" id="tv-ta-of-3-form">
        {{ csrf_field() }}
        {{ method_field('put') }}
        ...
        <div class="col-md-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <a href="{{ route('translate-tv-ta-index-3') }}" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
                </div>
            </div>
        </div>
    </form>
...
<script>
    $(function() {
        $('.btn-save').click(function() {
            $('#tv-ta-of-3-form').submit();
        });

        $('#chk-continue').on('ifChecked', function() {
            $('#tv-ta-of-3-form').attr('action', '');
        });
