...
<form role="form" action="{{ route('layout-tv-ta-assign-division-1', ['id' => $detailTask->id]) }}" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
		...
		<div class="col-md-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <select class="form-control select2" name="assign">
                            <option value="translate_tvta3">Giao Task Leader biên dịch 3</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                ...
                <div class="box-body">
                    ...
                    <a href="{{ route('layout-tv-ta-index-1') }}" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
                </div>
            </div>
		</div>
