...
<form role="form" action="{{ route('layout-assign-division', ['id' => $detailTask->id]) }}" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
                ...
                <div class="box-body">
                    <div class="form-group">
                        <select class="form-control select2" name="assign">
                            <option value="license2">Giao Task Leader Bản quyền 2</option>
                            <option value="language1">Giao Task Leader Ngôn ngữ 1</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
