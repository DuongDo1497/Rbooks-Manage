...
<form role="form" action="{{ route('print-assign-division', ['id' => $detailTask->id]) }}" method="post">
    {{ csrf_field() }}
    {{ method_field('put') }}
    ...
    <div class="row">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <select class="form-control select2" name="assign">
                            <option value="kho1">Giao Task Leader Kho 1</option>
                            <option value="sales2">Giao Task Leader Sales 2</option>
                            <option value="license3">Giao Task Leader Bản quyền 3</option>
                            <option value="operate2">Giao Task Leader Vận hành 2</option>
                            <option value="account2">Giao Task Leader Kế toán 2</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
        ...
        @include('task-manage.taskones.printing.ataskchildGeneral')
