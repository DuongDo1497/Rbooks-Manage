                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        @if(Auth::user()->roles()->first()->name == "Leader" || Auth::user()->roles()->first()->name == "owner")
                                            @if($detailTaskChild->status == 8 && Auth::user()->roles()->first()->name != "owner")
                                            ...
                                            @if($detailTaskChild->status < 11 || Auth::user()->roles()->first()->name == "owner")
                                                <li><a href="{{ route('design-edit-taskchild', ['id' => $detailTaskChild->id]) }}"><i class="fas fa-pencil-alt" style="margin-right: 10px;"></i> Chỉnh sửa</a></li>
