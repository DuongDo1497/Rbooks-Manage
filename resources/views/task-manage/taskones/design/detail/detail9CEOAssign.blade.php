...
<form role="form" action="{{ route('design-assign-division', ['id' => $detailTask->id]) }}" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
                ...
                <div class="box-body">
                    <div class="form-group">
                        <select class="form-control select2" name="assign">
                            <option value="it1">Giao Task Leader IT 1</option>
                            <option value="sales1">Giao Task Leader Sales 1</option>
                            <option value="license1">Giao Task Leader Bản quyền 1</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
