        ...
        <div class="box-header with-border">
            ...
            <div class="box-tools">
                <div class="btn-group btn-group-sm">
                    @if($detailTask->status > 1 && Auth::user()->roles()->first()->name == "Leader" || $detailTask->status > 1 && Auth::user()->roles()->first()->name == "owner" || $detailTask->status > 1 && Auth::user()->id == 235 || $detailTask->status > 1 && Auth::user()->id == 236)
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        @if(Auth::user()->roles()->first()->name == "Leader" || Auth::user()->roles()->first()->name == "owner")
                                            <li><a href="{{ route('sales-edit-taskchild', ['id' => $detailTaskChild->id]) }}"><i class="fas fa-pencil-alt" style="margin-right: 10px;"></i> Chỉnh sửa</a></li>
                                        ...
                                        @if($detailTask->status >= 8)
                                            ...
                                            @if($detailTaskChild->file_name != null)
                                                <li><a href="{{ route('download', ['iddivision' => $detailTask->division_id, 'file_name' => $detailTaskChild->file_name]) }}"><i class="fa fa-download" style="margin-right: 10px;"></i> Tải tệp xuống</a></li>
