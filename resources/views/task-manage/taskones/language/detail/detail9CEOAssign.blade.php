...
<form role="form" action="{{ route('language-assign-division', ['id' => $detailTask->id]) }}" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
	...
	<div class="row">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <select class="form-control select2" name="assign">
                            <option value="operate1">Giao Task Leader Vận hành 1</option>
                            <option value="translate_check_1">Giao Task Leader Biên dịch (check sách in)</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
		...
		@include('task-manage.taskones.language.ataskchildGeneral')
