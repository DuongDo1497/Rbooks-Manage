                    ...
                    @foreach($detailTask->detailTasks()->get() as $detailTaskChild)
                        ...
                        <tr>
                            ...
                            @elseif($detailTaskChild->status == 22)
                                <td style="text-align: center; color: green;"> {{ $statusTask['21'] }}</td>
                            ...
                            @elseif($detailTaskChild->status == 19)
                                <td style="text-align: center; color: red;"> {{ $statusTask['18'] }}</td>
                            @elseif($detailTaskChild->status == 21)
                                <td style="text-align: center; color: #088A85;"> {{ $statusTask['20'] }}</td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        @if(Auth::user()->roles()->first()->name == "owner")
                                            <li><a href="{{ route('operate-edit-taskchild', ['id' => $detailTaskChild->id]) }}"><i class="fas fa-pencil-alt" style="margin-right: 10px;"></i> Chỉnh sửa</a></li>
