<div class="modal fade" id="getFormAddTaskCombination" role="dialog">
    <form action="{{ route('warehouse_ones-store') }}?index=true" enctype="multipart/form-data" method="POST">
        {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nhập tổng số ngày" name="numday">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Ghi chú</label>
                        <textarea class="form-control" placeholder="Nhập ghi chú" rows="4" name="description"></textarea>
                    </div>
                </div>
