...
<form role="form" action="{{ route('translate-assign-division', ['id' => $detailTask->id]) }}?continue=true" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
		...
		<div class="col-md-4">
            <div class="box box-primary">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <select class="form-control select2" name="assign">
                                    <option value="design1">Giao Task Leader Design 1</option>
                                    <option value="marketing1">Giao Task Leader Makerting 1</option>
                                    <option value="translate2">Giao Task Leader Biên dịch 2 edit sách</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box-body">
                    ...
                    <a href="{{ route('translate_ones-index') }}" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
                </div>
            </div>
		</div>
        @include('task-manage.taskones.translate.ataskchildGeneral')
