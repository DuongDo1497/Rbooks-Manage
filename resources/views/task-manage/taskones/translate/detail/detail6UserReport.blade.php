	...
	<div class="row">
		...
		<div class="col-md-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                	<div class="form-group">
	                    <textarea class="form-control">Nhân Viên vào "Thao tác" chọn "Báo cáo", báo cáo đúng tiến độ công việc của mình, và nộp file báo cáo khi công việc hoàn thành 100%.</textarea>
                    </div>
                    <div class="form-group">
	                    <a href="{{ route('translate_ones-index') }}" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
                    </div>
