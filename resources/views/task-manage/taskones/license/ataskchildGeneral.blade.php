        ...
        <div class="box-header with-border">
            ...
            <div class="box-tools">
                <div class="btn-group btn-group-sm">
                    @if($detailTask->status > 1 && Auth::user()->roles()->first()->name == "owner")
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        @if(Auth::user()->roles()->first()->name == "owner")
                                            <li><a href="{{ route('license-edit-taskchild', ['id' => $detailTaskChild->id]) }}"><i class="fas fa-pencil-alt" style="margin-right: 10px;"></i> Chỉnh sửa</a></li>
                                            @if($detailTaskChild->initialization_user_id == Auth::user()->employee()->first()->id && $detailTaskChild->status == 8)
                                            ...
                                            @elseif($detailTaskChild->status == 11 && $detailTaskChild->initialization_user_id == Auth::user()->employee()->first()->id)
                                                <li><a href="#" data-toggle="modal" data-id="{{ $detailTaskChild->id }}" data-target="#getReportLicense" onclick="processReports('frm', '{{ $detailTaskChild->id }}')"><i class="fa fa-area-chart" style="margin-right: 10px;"></i> Báo cáo</a></li>
                                            @elseif($detailTaskChild->status > 11)
                                            ...
                                            @endif
                                            @if($detailTaskChild->file_name == null && $detailTaskChild->progress == 100)
                                                <li><a href="{{ route('taskchild-get-file', ['id' => $detailTaskChild->id, 'iddivision' => $division]) }}"><i class="fas fa-upload" style="margin-right: 10px;"></i> Tải tệp lên</a></li>
                                            @endif
                                            @if($detailTaskChild->file_name != null)
                                                <li><a href="{{ route('download', ['file_name' => $detailTaskChild->file_name, 'iddivision' => $division]) }}"><i class="fa fa-download" style="margin-right: 10px;"></i> Tải tệp xuống</a></li>
                                                <li><a href="{{ route('delete-file', ['id' => $detailTaskChild->id, 'file_name' => $detailTaskChild->file_name, 'iddivision' => $division]) }}"><i class="fa fa-times" style="margin-right: 10px;"></i> Xóa tệp</a></li>
                                            @endif
                                        ...
                                        @else
                                            @if($detailTaskChild->status >= 11 && $detailTaskChild->initialization_user_id == Auth()->user()->employee()->first()->id)
                                                @if($detailTaskChild->progress != 100)
                                                    <li><a href="#" data-toggle="modal" data-id="{{ $detailTaskChild->id }}" data-target="#getReportLicense" onclick="processReports('frm', '{{ $detailTaskChild->id }}')"><i class="fa fa-area-chart" style="margin-right: 10px;"></i> Báo cáo</a></li>
                                                @endif
                                                @if($detailTaskChild->file_name == null && $detailTaskChild->progress == 100)
                                                    <li><a href="{{ route('taskchild-get-file', ['id' => $detailTaskChild->id, 'iddivision' => $division]) }}"><i class="fas fa-upload" style="margin-right: 10px;"></i> Tải tệp lên</a></li>
                                                @elseif($detailTaskChild->file_name != null)
                                                    <li><a href="{{ route('download', ['file_name' => $detailTaskChild->file_name, 'iddivision' => $division]) }}"><i class="fa fa-download" style="margin-right: 10px;"></i> Tải tệp xuống</a></li>
                                                    @if($detailTaskChild->status != 18 && $detailTaskChild->status != 22)
                                                        <li><a href="{{ route('delete-file', ['id' => $detailTaskChild->id, 'file_name' => $detailTaskChild->file_name, 'iddivision' => $division]) }}"><i class="fa fa-times" style="margin-right: 10px;"></i> Xóa tệp</a></li>
                                                    @endif
                                                @endif
