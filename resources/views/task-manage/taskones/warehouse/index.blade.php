...
@endif
@include('task-manage.taskones.warehouse.search-form')
                		...
                		<div class="box">
                			...
                			<div class="box-body">
                				<div class="task-body">
                                    ...
                                    @endif
                                    @foreach($collections as $taskWare)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskWare->taskname }}">
                                            @if($taskWare->status < 22)
                                                @if((strtotime($taskWare->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) < 0)
                                                    <div class="task-name-item" style="color: gray"><b>{{ $taskWare->taskname }}</b></div>
                                                @elseif((strtotime($taskWare->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) <= 2)
                                                    <div class="task-name-item warning"><b>{{ $taskWare->taskname }}</b></div>
                                                @else
                                                    <div class="task-name-item"><b>{{ $taskWare->taskname }}</b></div>
                                                @endif
                                            @else
                                                <div class="task-name-item"><b>{{ $taskWare->taskname }}</b></div>
                                            @endif
                                            <div class="task-name-item">
                                                @if($taskWare->priority == 1) 
                                                    <span class="alert-warning"> Gấp/Quan trọng</span>
                                                @elseif($taskWare->priority == 2)
                                                    <span style="background-color: #F3E2A9"> Không gấp/QT</span>
                                                @elseif($taskWare->priority == 3)
                                                    <span style="background-color: #58FAAC"> Gấp/Không QT</span>
                                                @else
                                                    <span style="background-color: #E6E6E6"> Không gấp/KQT</span>
                                                @endif
                                                &nbsp;
                                                @if($taskWare->status > 0)
                                            ...
                                            <ul class="task-name-detail">
                                                <li><b>Loại dự án:</b> {{ $taskWare->tasktype }}</li>
                                                @if($taskWare->status < 22)
                                                    @if((strtotime($taskWare->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) < 0)
                                                        <li style="color: gray"><b>{{ trans('home.Thời gian') }}:</b> {{ date("d/m/Y", strtotime($taskWare->fromdate)) }} - {{ date("d/m/Y", strtotime($taskWare->todate)) }} (Đã hết hạn)</li>
                                                    @elseif((strtotime($taskWare->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) <= 2)
                                                        <li class="warning"><b>{{ trans('home.Thời gian') }}:</b> {{ date("d/m/Y", strtotime($taskWare->fromdate)) }} - {{ date("d/m/Y", strtotime($taskWare->todate)) }} (Gần hết hạn)</li>
                                                    @else
                                                        <li><b>{{ trans('home.Thời gian') }}:</b> {{ date("d/m/Y", strtotime($taskWare->fromdate)) }} - {{ date("d/m/Y", strtotime($taskWare->todate)) }}</li>
                                                    @endif
                                                @else
                                                    <li><b>{{ trans('home.Thời gian') }}:</b> {{ date("d/m/Y", strtotime($taskWare->fromdate)) }} - {{ date("d/m/Y", strtotime($taskWare->todate)) }}</li>
                                                @endif
                                                <li><b>Mô tả:</b> {{ $taskWare->description }}</li>
                                                <li><b>{{ trans('home.Ghi chú') }}:</b> {{ $taskWare->note }}</li>
                                                <li><b>Trạng thái:</b>
                                                    @if($taskWare->status == 0)
                                                        <b style="color: orange;"> Chưa nhận</b>
                                                    @else
                                                        <b style="color: green;"> Đã nhận</b>
                                                    @endif
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    @if($taskWare->status == 0 && Auth::user()->roles()->first()->name == 'owner' || $taskWare->status == 0 && Auth::user()->roles()->first()->name == 'Leader')
                                                        <li><a href="{{ route('receive-task', ['id' => $taskWare->id]) }}" class="task-edit" data-title="Chỉnh sửa"><i class="fa fa-check"></i> Nhận</a></li>
                                                    @else
                                                        <li><a href="#" class="task-edit" data-title="Đã nhận"><i class="fa fa-check"></i> Đã nhận</a></li>
                                                    @endif
                                                    @if(Auth::user()->roles()->first()->name == 'owner')
                                                        <li><a href="{{ route('warehouse_ones-edit', ['id' => $taskWare->id]) }}" class="task-edit" data-title="Chỉnh sửa"><i class="fa fa-pencil-square-o"></i> Chỉnh sửa</a></li>
                                                        <li>
                                                            <a href="javascript:void(0)" data-id="{{ $taskWare->id }}" class="btn-delete"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
                                                            <form name="form-delete-{{ $taskWare->id }}" method="post" action="{{ route('task-delete', ['id'=> $taskWare->id]) }}">
                                                                {{ csrf_field() }}
                                                                {{ method_field('delete') }}
                                                            </form>
                                                        </li>
                	...
                	<div class="task-manage-box">
                		<div class="box">
                			...
                			<div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 2) as $taskWare)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskWare->taskname }}">
                                            @if($taskWare->status < 22)
                                                @if((strtotime($taskWare->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) < 0)
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                @endif
                                                <br>
                                                @foreach($taskWare->detailTasks()->get()->where('status', '>=', 8) as $detailTask)
                                                <li><b>Công việc:</b>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('LeadWarehouseAssign', ['id' => $taskWare->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                	...
                	<div class="task-manage-box">
                		<div class="box">
                            ...
                            <div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 8) as $taskWare)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskWare->taskname }}">
                                            @if($taskWare->status < 22)
                                                @if((strtotime($taskWare->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) < 0)
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('UserWarehouseReceive', ['id' => $taskWare->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskWare->taskname }}">
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                @endif
                                                <br>
                                                @foreach($taskWare->detailTasks()->get()->where('status', '>=', 13) as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('LeadWarehouseApprove', ['id' => $taskWare->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                	...
                	<div class="task-manage-box">
                		<div class="box">
                			...
                			<div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 15) as $taskWare)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskWare->taskname }}">
                                            @if($taskWare->status < 22)
                                                @if((strtotime($taskWare->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) < 0)
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                @endif
                                                <br>
                                                @foreach($taskWare->detailTasks()->get()->where('status', '>=', 17) as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('CEOWarehouseApprove', ['id' => $taskWare->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @foreach($collections->where('status', '>=', 15) as $taskWare)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskWare->taskname }}">
                                            ...
                                            <ul class="task-name-detail">
                                                <li><b>Loại dự án:</b> {{ $taskWare->tasktype }}</li>
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskWare->fromdate)) }} - {{ date("d/m/Y", strtotime($taskWare->todate)) }}</li>
                                                <br>
                                                @foreach($taskWare->detailTasks()->get() as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
