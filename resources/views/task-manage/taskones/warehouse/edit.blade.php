...
<div class="row">
    <form role="form" action="{{ route('task-update', ['id' => $taskWarehouse->id]) }}?taskupdate=true" method="post" id="warehouse_ones-form">
        {{ csrf_field() }}
        {{ method_field('put') }}
        ...
        <div class="col-md-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <a href="{{ route('warehouse_ones-index') }}" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
                </div>
            </div>
        </div>
    </form>
...
<script>
    $(function() {
        $('.btn-save').click(function() {
            $('#warehouse_ones-form').submit();
        });

        $('#chk-continue').on('ifChecked', function() {
            $('#warehouse_ones-form').attr('action', '');
        });
