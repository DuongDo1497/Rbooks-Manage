<div class="modal fade" id="getFormAddTaskIt" role="dialog">
    <form action="{{ route('it_ones-store') }}?index=true" enctype="multipart/form-data" method="POST">
        {{ csrf_field() }}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Nhập dự án" name="tasktype">
                    </div>
                    <div class="form-group">
                        <label>Mức độ</label>
