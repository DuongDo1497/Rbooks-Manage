...
<div class="row">
    <form role="form" action="{{ route('task-update', ['id' => $taskTranslate->id]) }}?taskupdate=true" method="post" id="account_sach_rb-1-form">
        {{ csrf_field() }}
        {{ method_field('put') }}
        ...
        <div class="col-md-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <a href="{{ route('account_sach_rb-index-1') }}" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
                </div>
            </div>
        </div>
    </form>
