...
@endif
@include('task-manage.task_sach_rbooks.sales.search-form')
<style>
    ...
    <div class="col-xs-12">
        <div class="box box-list-task">
            <div class="box-header">
                <h3 class="box-title">Phủ sản phẩm</h3>
            </div>
            <div class="box-body">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="task-body">
                                    ...
                                    @endif
                                    @foreach($collections as $taskSale)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskSale->taskname }}">
                                            @if($taskSale->status < 22)
                                                @if((strtotime($taskSale->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) < 0)
                                                    <div class="task-name-item" style="color: gray"><b>{{ $taskSale->taskname }}</b></div>
                                                @elseif((strtotime($taskSale->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) <= 2)
                                                    <div class="task-name-item warning"><b>{{ $taskSale->taskname }}</b></div>
                                                @else
                                                    <div class="task-name-item"><b>{{ $taskSale->taskname }}</b></div>
                                                @endif
                                            @else
                                                <div class="task-name-item"><b>{{ $taskSale->taskname }}</b></div>
                                            @endif
                                            <div class="task-name-item">
                                                @if($taskSale->priority == 1) 
                                                    <span class="alert-warning"> Gấp/Quan trọng</span>
                                                @elseif($taskSale->priority == 2)
                                                    <span style="background-color: #F3E2A9"> Không gấp/QT</span>
                                                @elseif($taskSale->priority == 3)
                                                    <span style="background-color: #58FAAC"> Gấp/Không QT</span>
                                                @else
                                                    <span style="background-color: #E6E6E6"> Không gấp/KQT</span>
                                                @endif
                                                &nbsp;
                                                @if($taskSale->status > 0)
                                            ...
                                            <ul class="task-name-detail">
                                                <li><b>Loại dự án:</b> {{ $taskSale->project }}</li>
                                                @if($taskSale->status < 22)
                                                    @if((strtotime($taskSale->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) < 0)
                                                        <li style="color: gray"><b>{{ trans('home.Thời gian') }}:</b> {{ date("d/m/Y", strtotime($taskSale->fromdate)) }} - {{ date("d/m/Y", strtotime($taskSale->todate)) }} (Đã hết hạn)</li>
                                                    @elseif((strtotime($taskSale->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) <= 2)
                                                        <li class="warning"><b>{{ trans('home.Thời gian') }}:</b> {{ date("d/m/Y", strtotime($taskSale->fromdate)) }} - {{ date("d/m/Y", strtotime($taskSale->todate)) }} (Gần hết hạn)</li>
                                                    @else
                                                        <li><b>{{ trans('home.Thời gian') }}:</b> {{ date("d/m/Y", strtotime($taskSale->fromdate)) }} - {{ date("d/m/Y", strtotime($taskSale->todate)) }}</li>
                                                    @endif
                                                @else
                                                    <li><b>{{ trans('home.Thời gian') }}:</b> {{ date("d/m/Y", strtotime($taskSale->fromdate)) }} - {{ date("d/m/Y", strtotime($taskSale->todate)) }}</li>
                                                @endif
                                                <li><b>{{ trans('home.Mô tả') }}:</b> {{ $taskSale->description }}</li>
                                                <li><b>{{ trans('home.Ghi chú') }}:</b> {{ $taskSale->note }}</li>
                                                <li><b>Trạng thái:</b>
                                                    @if($taskSale->status == 0)
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    @if($taskSale->status == 0 && Auth::user()->roles()->first()->name == 'owner' || $taskSale->status == 0 && Auth::user()->roles()->first()->name == 'Leader')
                                                        <li><a href="{{ route('receive-task', ['id' => $taskSale->id]) }}" class="task-edit" data-title="Chỉnh sửa"><i class="fa fa-check"></i> Nhận</a></li>
                                                    @else
                                                        <li><a href="#" class="task-edit" data-title="Đã nhận"><i class="fa fa-check"></i> Đã nhận</a></li>
                                                    @endif
                                                    @if(Auth::user()->roles()->first()->name == 'owner')
                                                        <li><a href="{{ route('sales_sach_rbooks-edit-1', ['id' => $taskSale->id]) }}" class="task-edit" data-title="Chỉnh sửa"><i class="fa fa-pencil-square-o"></i> Chỉnh sửa</a></li>
                                                        <li>
                                                            <a href="javascript:void(0)" data-id="{{ $taskSale->id }}" class="btn-delete"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
                                                            <form name="form-delete-{{ $taskSale->id }}" method="post" action="{{ route('task-delete', ['id'=> $taskSale->id]) }}">
                                                                {{ csrf_field() }}
                                                                {{ method_field('delete') }}
                                                            </form>
                                                        </li>
                    ...
                    <div class="task-manage-box">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 2) as $taskSale)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskSale->taskname }}">
                                            @if($taskSale->status < 22)
                                                @if((strtotime($taskSale->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) < 0)
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                @endif
                                                <br>
                                                @foreach($taskSale->detailTasks()->get()->where('status', '>=', 8) as $detailTask)
                                                <li><b>Công việc:</b>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('sales_sach_rbooks_leadassign_1', ['id' => $taskSale->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="task-manage-box">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 8) as $taskSale)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskSale->taskname }}">
                                            @if($taskSale->status < 22)
                                                @if((strtotime($taskSale->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) < 0)
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('sales_sach_rbooks_receive_1', ['id' => $taskSale->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="task-manage-box">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 13) as $taskSale)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskSale->taskname }}">
                                            @if($taskSale->status < 22)
                                                @if((strtotime($taskSale->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) < 0)
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                @endif
                                                <br>
                                                @foreach($taskSale->detailTasks()->get()->where('status', '>=', 13) as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('sales_sach_rbooks_lead_approve_1', ['id' => $taskSale->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="task-manage-box">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 15) as $taskSale)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskSale->taskname }}">
                                            @if($taskSale->status < 22)
                                                @if((strtotime($taskSale->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) < 0)
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                @endif
                                                <br>
                                                @foreach($taskSale->detailTasks()->get()->where('status', '>=', 17) as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('sales_sach_rbooks_ceo_approve_report_1', ['id' => $taskSale->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskSale->taskname }}">
                                            ...
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskSale->detailTasks()->get()->where('status', '>=', 22)->count() == $taskSale->detailTasks()->get()->count())
                                            ...
                                            <ul class="task-name-detail">
                                                <li><b>Loại dự án:</b> {{ $taskSale->project }}</li>
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskSale->fromdate)) }} - {{ date("d/m/Y", strtotime($taskSale->todate)) }}</li>
                                                <li><b>Mô tả:</b> {{ $taskSale->description }}</li>
                                                <br>
                                                @foreach($taskSale->detailTasks()->get()->where('status', 22) as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
