...
<div class="row">
    <form role="form" action="{{ route('task-update', ['id' => $taskSales->id]) }}?taskupdate=true" method="post" id="sales_sach_rbooks-1-form">
        {{ csrf_field() }}
        {{ method_field('put') }}
        ...
        <div class="col-md-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <a href="{{ route('sales_sach_rbooks-index-1') }}" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
                </div>
            </div>
        </div>
    </form>
...
<script>
    $(function() {
        $('.btn-save').click(function() {
            $('#sales_sach_rbooks-1-form').submit();
        });

        $('#chk-continue').on('ifChecked', function() {
            $('#sales_sach_rbooks-1-form').attr('action', '');
        });
