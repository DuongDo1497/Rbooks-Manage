                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        @if(Auth::user()->roles()->first()->name == "Leader" || Auth::user()->roles()->first()->name == "owner")
                                            <li><a href="{{ route('taskChild-edit-print-rb-1', ['id' => $detailTaskChild->id]) }}"><i class="fas fa-pencil-alt" style="margin-right: 10px;"></i> Chỉnh sửa</a></li>
                                        ...
                                        @endif
                                            <li><a href="javascript:void(0)" data-id="{{ $detailTaskChild->id }}" class="btn-delete"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
                                                <form style="margin: 0;" name="form-delete-{{ $detailTaskChild->id }}" method="post" action="{{ route('translate_ones-delete', ['id'=> $detailTaskChild->id]) }}">
                                                    {{ csrf_field() }}
                                                    <!-- method('delete') -->
                                                </form>
                                            </li>
