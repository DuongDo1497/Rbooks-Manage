...
<form role="form" action="{{ route('print_sach_rb-assign-division-1', ['id' => $detailTask->id]) }}" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
                ...
                <div class="box-body">
                    <div class="form-group">
                        <select class="form-control select2" name="assign">
                            <option value="account_rbooks2">Giao Task Leader Kế toán 2</option>
                            <option value="warehouse_rbooks1">Giao Task Leader Kho</option>
                            <option value="operate_rbooks2">Giao Task Leader Vận hành 2</option>
                            <option value="sales_rbooks2">Giao Task Leader Sales 2</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
