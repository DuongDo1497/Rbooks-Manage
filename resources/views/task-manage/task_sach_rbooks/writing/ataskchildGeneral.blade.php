                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        @if(Auth::user()->roles()->first()->name == "Leader" || Auth::user()->roles()->first()->name == "owner")
                                            <li><a href="{{ route('writing-edit-taskchild', ['id' => $detailTaskChild->id]) }}"><i class="fas fa-pencil-alt" style="margin-right: 10px;"></i> Chỉnh sửa</a></li>
                                        ...
                                        @elseif($detailTaskChild->status >= 11 && $detailTaskChild->initialization_user_id == Auth()->user()->employee()->first()->id)
                                            ...
                                            @elseif($detailTaskChild->file_name != null)
                                                <li><a href="{{ route('download', ['iddivision' => $division, 'file_name' => $detailTaskChild->file_name]) }}"><i class="fa fa-download" style="margin-right: 10px;"></i> Tải tệp xuống</a></li>
