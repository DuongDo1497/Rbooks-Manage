<div class="box box-default">
    <form action="{{ route('writing_sach_rbooks-index-1') }}">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select class="form-control select2" data-minimum-results-for-search="Infinity" name="filter_status" id="filter_status">
                            ...
                            <option value="1">Leader không duyệt</option>
                            <option value="4">CEO không duyệt</option>
        ...
        <div class="box-footer text-right">
            ...
            <a href="{{ route('writing_sach_rbooks-index-1') }}" class="btn btn-default">{{ trans('home.Xóa') }} form</a>
        </div>
    </form>
</div>