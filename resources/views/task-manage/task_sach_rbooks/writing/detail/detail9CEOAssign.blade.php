...
<form role="form" action="{{ route('writing_sach_rbooks-assign-division-1', ['id' => $detailTask->id]) }}?continue=true" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
	...
	<div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <select class="form-control select2" name="assign">
                                    <option value="design_rbooks1">Giao Task Leader Design</option>
                                    <option value="mkt_rbooks1">Giao Task Leader Marketing</option>
                                    <option value="ceo_rbooks1">Giao Task CEO</option>
                                </select>
                            </div>
                        </div>
                    </div>
		...
		@include('task-manage.task_sach_rbooks.writing.ataskchildGeneral')
	</div>
</form>
