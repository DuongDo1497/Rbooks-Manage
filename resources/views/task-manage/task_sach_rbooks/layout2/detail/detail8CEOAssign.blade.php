...
<form role="form" action="{{ route('layout_sach_rb-assign-division-2', ['id' => $detailTask->id]) }}" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
                ...
                <div class="box-body">
                    <div class="form-group">
                        <select class="form-control select2" name="assign">
                            <option value="writing_rbooks3">Giao Task Leader Writing 3</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
