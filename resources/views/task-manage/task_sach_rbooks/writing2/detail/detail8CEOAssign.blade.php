...
<form role="form" action="{{ route('writing_sach_rb-assign-division-2', ['id' => $detailTask->id]) }}" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
		...
		<div class="col-md-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <select class="form-control select2" name="assign">
                            <option value="layout_rbooks1">Giao Task Leader Dàn trang</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                ...
                <div class="box-body">
                    ...
                    <a href="{{ route('writing_sach_rb-index-2') }}" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
                </div>
            </div>
		</div>
