...
<form role="form" action="{{ route('design_sach_rb-assign-division-2', ['id' => $detailTask->id]) }}" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
		...
		<div class="col-md-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <select class="form-control select2" name="assign">
                            <option value="print_rbooks1">Giao Task Leader In ấn 1</option>
                            <option value="sales_rbooks1">Giao Task Leader Sales 1</option>
                            <option value="marketing_rbooks2">Giao Task Leader Marketing 2</option>
                            <option value="it_rbooks3">Giao Task Leader IT 3</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                ...
                <div class="box-body">
                    ...
                    <a href="{{ route('design_sach_rb-index-2') }}" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
                </div>
            </div>
		</div>
