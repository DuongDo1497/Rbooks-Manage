...
<div class="row">
    <form role="form" action="{{ route('task-update', ['id' => $taskDesign->id]) }}?taskupdate=true" method="post" id="design_sach_rb-2-form">
        {{ csrf_field() }}
        {{ method_field('put') }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nhập tổng số ngày" name="numday" value="{{ $taskDesign->numday }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    $(function() {
        $('.btn-save').click(function() {
            $('#design_sach_rb-2-form').submit();
        });

        $('#chk-continue').on('ifChecked', function() {
            $('#design_sach_rb-2-form').attr('action', '');
        });
