...
<form role="form" action="{{ route('mkt_sach_rbooks-assign-division-1', ['id' => $detailTask->id]) }}" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
		...
		<div class="col-md-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <select class="form-control select2" name="assign">
                            <option value="sales_rbooks1">Giao Task Leader Sales</option>
                            <option value="mkt_rbooks2">Giao Task Leader Marketing 2</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                ...
                <div class="box-body">
                    ...
                    <a href="{{ route('mkt_sach_rbooks-index-1') }}" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
                </div>
            </div>
		</div>
