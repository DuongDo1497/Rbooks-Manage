...
@endif
@include('task-manage.task_sach_rbooks.marketing.search-form')
<style>
    ...
    <div class="col-xs-12">
        <div class="box box-list-task">
            <div class="box-header">
                <h3 class="box-title">Plan phủ sách</h3>
            </div>
            <div class="box-body">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="task-body">
                                    ...
                                    @endif
                                    @foreach($collections as $taskMarketing)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskMarketing->taskname }}">
                                            @if($taskMarketing->status < 22)
                                                @if((strtotime($taskMarketing->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) < 0)
                                                    <div class="task-name-item" style="color: gray"><b>{{ $taskMarketing->taskname }}</b></div>
                                                @elseif((strtotime($taskMarketing->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) <= 2)
                                                    <div class="task-name-item warning"><b>{{ $taskMarketing->taskname }}</b></div>
                                                @else
                                                    <div class="task-name-item"><b>{{ $taskMarketing->taskname }}</b></div>
                                                @endif
                                            @else
                                                <div class="task-name-item"><b>{{ $taskMarketing->taskname }}</b></div>
                                            @endif
                                            <div class="task-name-item">
                                                @if($taskMarketing->priority == 1) 
                                                    <span class="alert-warning"> Gấp/Quan trọng</span>
                                                @elseif($taskMarketing->priority == 2)
                                                    <span style="background-color: #F3E2A9"> Không gấp/QT</span>
                                                @elseif($taskMarketing->priority == 3)
                                                    <span style="background-color: #58FAAC"> Gấp/Không QT</span>
                                                @else
                                                    <span style="background-color: #E6E6E6"> Không gấp/KQT</span>
                                                @endif
                                                &nbsp;
                                                @if($taskMarketing->status > 0)
                                            ...
                                            <ul class="task-name-detail">
                                                <li><b>Loại dự án:</b> {{ $taskMarketing->project }}</li>
                                                @if($taskMarketing->status < 22)
                                                    @if((strtotime($taskMarketing->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) < 0)
                                                        <li style="color: gray"><b>{{ trans('home.Thời gian') }}:</b> {{ date("d/m/Y", strtotime($taskMarketing->fromdate)) }} - {{ date("d/m/Y", strtotime($taskMarketing->todate)) }} (Đã hết hạn)</li>
                                                    @elseif((strtotime($taskMarketing->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) <= 2)
                                                        <li class="warning"><b>{{ trans('home.Thời gian') }}:</b> {{ date("d/m/Y", strtotime($taskMarketing->fromdate)) }} - {{ date("d/m/Y", strtotime($taskMarketing->todate)) }} (Gần hết hạn)</li>
                                                    @else
                                                        <li><b>{{ trans('home.Thời gian') }}:</b> {{ date("d/m/Y", strtotime($taskMarketing->fromdate)) }} - {{ date("d/m/Y", strtotime($taskMarketing->todate)) }}</li>
                                                    @endif
                                                @else
                                                    <li><b>{{ trans('home.Thời gian') }}:</b> {{ date("d/m/Y", strtotime($taskMarketing->fromdate)) }} - {{ date("d/m/Y", strtotime($taskMarketing->todate)) }}</li>
                                                @endif
                                                <li><b>{{ trans('home.Mô tả') }}:</b> {{ $taskMarketing->description }}</li>
                                                <li><b>{{ trans('home.Ghi chú') }}:</b> {{ $taskMarketing->note }}</li>
                                                <li><b>Trạng thái:</b>
                                                    @if($taskMarketing->status == 0)
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    @if($taskMarketing->status == 0 && Auth::user()->roles()->first()->name == 'owner' || $taskMarketing->status == 0 && Auth::user()->roles()->first()->name == 'Leader')
                                                        <li><a href="{{ route('receive-task', ['id' => $taskMarketing->id]) }}" class="task-edit" data-title="Chỉnh sửa"><i class="fa fa-check"></i> Nhận</a></li>
                                                    @else
                                                        <li><a href="#" class="task-edit" data-title="Đã nhận"><i class="fa fa-check"></i> Đã nhận</a></li>
                                                    @endif
                                                    @if(Auth::user()->roles()->first()->name == 'owner')
                                                        <li><a href="{{ route('mkt_sach_rbooks-edit-1', ['id' => $taskMarketing->id]) }}" class="task-edit" data-title="Chỉnh sửa"><i class="fa fa-pencil-square-o"></i> Chỉnh sửa</a></li>
                                                        <li>
                                                            <a href="javascript:void(0)" data-id="{{ $taskMarketing->id }}" class="btn-delete"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
                                                            <form name="form-delete-{{ $taskMarketing->id }}" method="post" action="{{ route('task-delete', ['id'=> $taskMarketing->id]) }}">
                                                                {{ csrf_field() }}
                                                                {{ method_field('delete') }}
                                                            </form>
                                                        </li>
                    ...
                    <div class="task-manage-box">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 2) as $taskMarketing)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskMarketing->taskname }}">
                                            @if($taskMarketing->status < 22)
                                                @if((strtotime($taskMarketing->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) < 0)
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                @endif
                                                <br>
                                                @foreach($taskMarketing->detailTasks()->get()->where('status', '>=', 8) as $detailTask)
                                                <li><b>Công việc:</b>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('mkt_sach_rbooks_leadassign_1', ['id' => $taskMarketing->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="task-manage-box">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 8) as $taskMarketing)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskMarketing->taskname }}">
                                            @if($taskMarketing->status < 22)
                                                @if((strtotime($taskMarketing->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) < 0)
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('mkt_sach_rbooks_receive_1', ['id' => $taskMarketing->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="task-manage-box">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 13) as $taskMarketing)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskMarketing->taskname }}">
                                            @if($taskMarketing->status < 22)
                                                @if((strtotime($taskMarketing->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) < 0)
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                @endif
                                                <br>
                                                @foreach($taskMarketing->detailTasks()->get()->where('status', '>=', 13) as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('mkt_sach_rbooks_lead_approve_1', ['id' => $taskMarketing->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="task-manage-box">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 15) as $taskMarketing)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskMarketing->taskname }}">
                                            @if($taskMarketing->status < 22)
                                                @if((strtotime($taskMarketing->todate) - strtotime(Carbon\Carbon::now()->toDateString())) / (60 * 60 * 24) < 0)
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                @endif
                                                <br>
                                                @foreach($taskMarketing->detailTasks()->get()->where('status', '>=', 17) as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('mkt_sach_rbooks_ceo_approve_report_1', ['id' => $taskMarketing->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskMarketing->taskname }}">
                                            ...
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskMarketing->assigned_status == 25)
                                                    <span class="alert-success"> {{ trans('home.Hoàn thành') }}</span>
                                                @else
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                @endif
                                                <br>
                                                @foreach($taskMarketing->detailTasks()->get()->where('status', '>=', 21) as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('mkt_sach_rbooks_ceo_assign_1', ['id' => $taskMarketing->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
