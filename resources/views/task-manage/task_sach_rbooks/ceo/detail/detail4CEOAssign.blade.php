...
<form role="form" action="{{ route('ceo_sach_rbooks-assign-division-1', ['id' => $detailTask->id]) }}" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
	...
	<div class="row">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <select class="form-control select2" name="assign">
                            <option value="writing_rbooks2">Giao Task Leader Writing</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
		...
		@include('task-manage.taskones.ceo.ataskchildGeneral')
	</div>
</form>
