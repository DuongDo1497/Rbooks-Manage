...
<form role="form" action="{{ route('operate_sach_rb-assign-division-1', ['id' => $detailTask->id]) }}" method="post">
    {{ csrf_field() }}
    {{ method_field('put') }}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <select class="form-control select2" name="assign">
                                    <option value="account_rbooks1">Giao Task Leader Kế toán 1</option>
                                    <option value="layout_rbooks2">Giao Task Leader Dàn trang 2</option>
                                    <option value="it_rbooks2">Giao Task Leader IT 2</option>
                                </select>
                            </div>
                        </div>
                    </div>
