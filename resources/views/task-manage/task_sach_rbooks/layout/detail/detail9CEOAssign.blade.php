...
<form role="form" action="{{ route('layout_sach_rb-assign-division-1', ['id' => $detailTask->id]) }}" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
                ...
                <div class="box-body">
                    <div class="form-group">
                        <select class="form-control select2" name="assign">
                            <option value="operate_rbooks1">Giao Task Leader Vận hành</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
