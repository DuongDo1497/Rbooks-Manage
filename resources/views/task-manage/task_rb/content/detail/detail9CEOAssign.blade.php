...
<form role="form" action="{{ route('content_project_rb-assign-division-1', ['id' => $detailTask->id]) }}" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
	...
	<div class="row">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <select class="form-control select2" name="assign">
                            <option value="it_rb2">Giao Task Leader IT 2</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
		...
		@include('task-manage.task_rb.content.ataskchildGeneral')
