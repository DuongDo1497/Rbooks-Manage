...
<div class="row">
    <form role="form" action="{{ route('task-update', ['id' => $taskContent->id]) }}?taskupdate=true" method="post" id="content_projects-1-form">
        {{ csrf_field() }}
        {{ method_field('put') }}
        ...
        <div class="col-md-8">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label>Mô tả</label>
                        <textarea class="form-control" placeholder="Nhập môn tả" rows="4" name="description">{{ $taskContent->description }}</textarea>
                    </div>
                    <div class="form-group">
                        <label>Ghi chú</label>
        ...
        <div class="col-md-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <a href="{{ route('content_projects-index-1') }}" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
                </div>
            </div>
        </div>
    </form>
...
<script>
    $(function() {
        $('.btn-save').click(function() {
            $('#content_projects-1-form').submit();
        });

        $('#chk-continue').on('ifChecked', function() {
            $('#content_projects-1-form').attr('action', '');
        });
