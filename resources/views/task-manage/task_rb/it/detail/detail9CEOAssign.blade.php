...
<form role="form" action="{{ route('it_project_rb-assign-division-1', ['id' => $detailTask->id]) }}?continue=true" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <select class="form-control select2" name="assign">
                                    <option value="design_rb1">Giao Task Leader Design 1</option>
                                    <option value="content_rb1">Giao Task Leader Content 1</option>
                                </select>
                            </div>
                        </div>
                    </div>
