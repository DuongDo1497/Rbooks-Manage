...
<form role="form" class="demo" action="{{ route('task_ones-approve', ['id' => $detailTask->id]) }}" method="post">
	{{ csrf_field() }}
	{{ method_field('put') }}
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                	<div class="form-group">
	                    <textarea class="form-control">Task việc đã được khởi tạo thành công!.</textarea>
                    </div>
                </div>
            </div>
		</div>
