        ...
        <div class="box-header with-border">
            ...
            <div class="box-tools">
                <div class="btn-group btn-group-sm">
                    @if($detailTask->status > 1 && Auth::user()->roles()->first()->name == "Leader" || $detailTask->status > 1 && Auth::user()->roles()->first()->name == "owner" || $detailTask->status > 1 && Auth::user()->id == 231)
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        @if(Auth::user()->roles()->first()->name == "Leader" || Auth::user()->roles()->first()->name == "owner")
                                            <li><a href="{{ route('hr-edit-taskchild', ['id' => $detailTaskChild->id]) }}"><i class="fas fa-pencil-alt" style="margin-right: 10px;"></i> Chỉnh sửa</a></li>
