                		...
                		<div class="box">
                			...
                			<div class="box-body">
                				<div class="task-body">
                                    ...
                                    @endif
                                    @foreach($collections->where('status', '>=', 0) as $taskWarehouse)
                					<div class="task-items clearfix">
                						<div class="task-name" title="{{ $taskWarehouse->taskname }}">
                                            ...
                                            <div class="task-name-item">
                                                ...
                                                @elseif($taskWarehouse->status == 1 || $taskWarehouse->status == 4)
                                            ...
                                            <ul class="task-name-detail">
                                                <li><b>Loại dự án:</b> {{ $taskWarehouse->tasktype }}</li>
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskWarehouse->fromdate)) }} - {{ date("d/m/Y", strtotime($taskWarehouse->todate)) }}</li>
                                                <li><b>Trạng thái:</b>
                                                    @if($taskWarehouse->status == 0 || $taskWarehouse->status == 3 || $taskWarehouse->status > 4)
                                                        <b style="color: green;"> {{ $statusTask['0'] }}</b>
                                                    @elseif($taskWarehouse->status == 1)
                                                        <b style="color: red;"> {{ $statusTask['1'] }}</b>
                                                    @elseif($taskWarehouse->status == 4)
                                                        <b style="color: red;"> {{ $statusTask['4'] }}</b>
                                                    @endif
                                                </li>
                                                <li><b>Người khởi tạo:</b> {{ $taskWarehouse->user()->first()->name }}</li>
                                            </ul>
                                        </div>
                						...
                						<div class="task-function">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('warehouse_other_create', ['id' => $taskWarehouse->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                    @if($taskWarehouse->status == 0 || $taskWarehouse->status == 1 || Auth()->user()->roles()->first()->name == 'owner')
                                                        <li><a href="{{ route('warehouse_others-edit', ['id' => $taskWarehouse->id]) }}" class="task-edit" data-title="Chỉnh sửa"><i class="fa fa-pencil-square-o"></i> Chỉnh sửa</a></li>
                                                        <li>
                                                            <a href="javascript:void(0)" data-id="{{ $taskWarehouse->id }}" class="btn-delete"><i class="fa fa-trash" aria-hidden="true"></i> {{ trans('home.Xóa') }}</a>
                                    ...
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskWarehouse->taskname }}">
                                            ...
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskWarehouse->status == 3 || $taskWarehouse->status > 5)
                                                    <span class="alert-success"> Đã duyệt</span>
                                                @elseif($taskWarehouse->status == 0)
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Trạng thái:</b>
                                                    ...
                                                    @elseif($taskWarehouse->status == 1)
                                                        <b style="color: red;"> {{ $statusTask['1'] }}</b>
                                                    @elseif($taskWarehouse->status == 3 || $taskWarehouse->status > 5)
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('warehouse_other_leadapprove', ['id' => $taskWarehouse->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                	...
                	<div class="task-manage-box">
                		<div class="box">
                			...
                			<div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 3) as $taskWarehouse)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskWarehouse->taskname }}">
                                            <div class="task-name-item"><b>{{ $taskWarehouse->taskname }}</b></div>
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskWarehouse->status > 5)
                                                    <span class="alert-success"> Đã duyệt</span>
                                                @elseif($taskWarehouse->status == 4 || $taskWarehouse->status == 1)
                                                    <span class="alert-danger"> Không duyệt</span>
                                                @elseif($taskWarehouse->status == 3)
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskWarehouse->fromdate)) }} - {{ date("d/m/Y", strtotime($taskWarehouse->todate)) }}</li>
                                                <li><b>Trạng thái:</b>
                                                    @if($taskWarehouse->status == 3)
                                                        <b style="color: orange;"> {{ $statusTask['5'] }}</b>
                                                    @elseif($taskWarehouse->status >= 6)
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('warehouse_other_ceoapprove', ['id' => $taskWarehouse->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                	...
                	<div class="task-manage-box">
                		<div class="box">
                			...
                			<div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 6) as $taskWarehouse)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskWarehouse->taskname }}">
                                            <div class="task-name-item"><b>{{ $taskWarehouse->taskname }}</b></div>
                                            <div class="task-name-item">
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskWarehouse->fromdate)) }} - {{ date("d/m/Y", strtotime($taskWarehouse->todate)) }}</li>
                                                <br>
                                                @foreach($taskWarehouse->detailTasks()->get()->where('status', '>=', 6) as $detailTask)
                                                <li><b>Công việc:</b>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('warehouse_other_leadassign', ['id' => $taskWarehouse->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskWarehouse->taskname }}">
                                            ...
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskWarehouse->detailTasks()->get()->where('status', '>=', 11)->count() == $taskWarehouse->detailTasks()->get()->count())
                                                    <span class="alert-success"> Hoàn thành</span>
                                                @else
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('warehouse_user_receive', ['id' => $taskWarehouse->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                	...
                	<div class="task-manage-box">
                		<div class="box">
                			...
                			<div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 11) as $taskWarehouse)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskWarehouse->taskname }}">
                                            <div class="task-name-item"><b>{{ $taskWarehouse->taskname }}</b></div>
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskWarehouse->detailTasks()->get()->where('status', '>=', 14)->count() == $taskWarehouse->detailTasks()->get()->count())
                                                    <span class="alert-success"> Hoàn thành</span>
                                                @else
                                                    <span class="alert-info"> Đang làm</span>
                                                @endif
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskWarehouse->fromdate)) }} - {{ date("d/m/Y", strtotime($taskWarehouse->todate)) }}</li>
                                                <br>
                                                @foreach($taskWarehouse->detailTasks()->get()->where('status', '>=', 11) as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('warehouse_user_report', ['id' => $taskWarehouse->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskWarehouse->taskname }}">
                                            ...
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskWarehouse->detailTasks()->get()->where('status', '>=', 15)->count() == $taskWarehouse->detailTasks()->get()->count())
                                                    <span class="alert-success"> Hoàn thành</span>
                                                @else
                                                    <span class="alert-info"> Đang làm</span>
                                                @endif
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('warehouse_lead_approve', ['id' => $taskWarehouse->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="task-items clearfix">
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('warehouse_ceo_approve_report', ['id' => $taskWarehouse->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskWarehouse->taskname }}">
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskWarehouse->fromdate)) }} - {{ date("d/m/Y", strtotime($taskWarehouse->todate)) }}</li>
                                                <br>
                                                @foreach($taskWarehouse->detailTasks()->get()->where('status', '>=', 21) as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
...
@include('task-manage.taskothers.warehouse.add')
@endsection
