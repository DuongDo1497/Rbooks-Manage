                		...
                		<div class="box">
                			...
                			<div class="box-body">
                				<div class="task-body">
                                    ...
                                    @endif
                                    @foreach($collections->where('status', '>=', 0) as $taskAccount)
                					<div class="task-items clearfix">
                						<div class="task-name" title="{{ $taskAccount->taskname }}">
                                            ...
                                            <div class="task-name-item">
                                                ...
                                                @elseif($taskAccount->status == 1 || $taskAccount->status == 4)
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Trạng thái:</b>
                                                    @if($taskAccount->status == 0 || $taskAccount->status == 3 || $taskAccount->status > 4)
                                                        <b style="color: green;"> {{ $statusTask['0'] }}</b>
                                                    @elseif($taskAccount->status == 1)
                                                        <b style="color: red;"> {{ $statusTask['1'] }}</b>
                                                    @elseif($taskAccount->status == 4)
                                                        <b style="color: red;"> {{ $statusTask['4'] }}</b>
                                                    @endif
                                                </li>
                                                <li><b>Người khởi tạo:</b> {{ $taskAccount->user()->first()->name }}</li>
                                            </ul>
                                        </div>
                						...
                						<div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('account_other_create', ['id' => $taskAccount->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                    @if($taskAccount->status == 0 || $taskAccount->status == 1 || Auth()->user()->roles()->first()->name == 'owner')
                                                        <li><a href="{{ route('account_others-edit', ['id' => $taskAccount->id]) }}" class="task-edit" data-title="Chỉnh sửa"><i class="fa fa-pencil-square-o"></i> Chỉnh sửa</a></li>
                                                        <li>
                                                            <a href="javascript:void(0)" data-id="{{ $taskAccount->id }}" class="btn-delete"><i class="fa fa-trash" aria-hidden="true"></i> {{ trans('home.Xóa') }}</a>
                                    ...
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskAccount->taskname }}">
                                            ...
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskAccount->status == 3 || $taskAccount->status > 5)
                                                    <span class="alert-success"> Đã duyệt</span>
                                                @elseif($taskAccount->status == 0)
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Trạng thái:</b>
                                                    ...
                                                    @elseif($taskAccount->status == 1)
                                                        <b style="color: red;"> {{ $statusTask['1'] }}</b>
                                                    @elseif($taskAccount->status == 3 || $taskAccount->status > 5)
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('account_other_leadapprove', ['id' => $taskAccount->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                	...
                	<div class="task-manage-box">
                		<div class="box">
                			...
                			<div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 3) as $taskAccount)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskAccount->taskname }}">
                                            <div class="task-name-item"><b>{{ $taskAccount->taskname }}</b></div>
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskAccount->status > 5)
                                                    <span class="alert-success"> Đã duyệt</span>
                                                @elseif($taskAccount->status == 4 || $taskAccount->status == 1)
                                                    <span class="alert-danger"> Không duyệt</span>
                                                @elseif($taskAccount->status == 3)
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskAccount->fromdate)) }} - {{ date("d/m/Y", strtotime($taskAccount->todate)) }}</li>
                                                <li><b>Trạng thái:</b>
                                                    @if($taskAccount->status == 3)
                                                        <b style="color: orange;"> {{ $statusTask['5'] }}</b>
                                                    @elseif($taskAccount->status >= 6)
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('account_other_ceoapprove', ['id' => $taskAccount->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                	...
                	<div class="task-manage-box">
                		<div class="box">
                			...
                			<div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 6) as $taskAccount)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskAccount->taskname }}">
                                            <div class="task-name-item"><b>{{ $taskAccount->taskname }}</b></div>
                                            <div class="task-name-item">
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskAccount->fromdate)) }} - {{ date("d/m/Y", strtotime($taskAccount->todate)) }}</li>
                                                <br>
                                                @foreach($taskAccount->detailTasks()->get()->where('status', '>=', 6) as $detailTask)
                                                <li><b>Công việc:</b>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('account_other_leadassign', ['id' => $taskAccount->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskAccount->taskname }}">
                                            ...
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskAccount->detailTasks()->get()->where('status', '>=', 11)->count() == $taskAccount->detailTasks()->get()->count())
                                                    <span class="alert-success"> Hoàn thành</span>
                                                @else
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('account_user_receive', ['id' => $taskAccount->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                	...
                	<div class="task-manage-box">
                		<div class="box">
                			...
                			<div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 11) as $taskAccount)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskAccount->taskname }}">
                                            <div class="task-name-item"><b>{{ $taskAccount->taskname }}</b></div>
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskAccount->detailTasks()->get()->where('status', '>=', 14)->count() == $taskAccount->detailTasks()->get()->count())
                                                    <span class="alert-success"> Hoàn thành</span>
                                                @else
                                                    <span class="alert-info"> Đang làm</span>
                                                @endif
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskAccount->fromdate)) }} - {{ date("d/m/Y", strtotime($taskAccount->todate)) }}</li>
                                                <br>
                                                @foreach($taskAccount->detailTasks()->get()->where('status', '>=', 11) as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('account_user_report', ['id' => $taskAccount->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                	...
                	<div class="task-manage-box">
                		<div class="box">
                			...
                			<div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 13) as $taskAccount)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskAccount->taskname }}">
                                            <div class="task-name-item"><b>{{ $taskAccount->taskname }}</b></div>
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskAccount->detailTasks()->get()->where('status', '>=', 15)->count() == $taskAccount->detailTasks()->get()->count())
                                                    <span class="alert-success"> Hoàn thành</span>
                                                @else
                                                    <span class="alert-info"> Đang làm</span>
                                                @endif
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('account_lead_approve', ['id' => $taskAccount->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="task-items clearfix">
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('account_ceo_approve_report', ['id' => $taskAccount->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
...
@include('task-manage.taskothers.account.add')
@endsection
