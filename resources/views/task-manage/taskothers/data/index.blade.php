                		...
                		<div class="box">
                			...
                			<div class="box-body">
                				<div class="task-body">
                                    ...
                                    @endif
                                    @foreach($collections->where('status', '>=', 0) as $taskData)
                					<div class="task-items clearfix">
                						<div class="task-name" title="{{ $taskData->taskname }}">
                                            <div class="task-name-item"><b>{{ $taskData->taskname }}</b></div>
                                            <div class="task-name-item">
                                                @if($taskData->priority == 1) 
                                                    <span class="alert-warning"> Gấp/Quan trọng</span>
                                                @elseif($taskData->priority == 2)
                                                    <span style="background-color: #F3E2A9"> Không gấp/QT</span>
                                                @elseif($taskData->priority == 3)
                                                ...
                                                @elseif($taskData->status == 1 || $taskData->status == 4)
                                            ...
                                            <ul class="task-name-detail">
                                                <li><b>Loại dự án:</b> {{ $taskData->tasktype }}</li>
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskData->fromdate)) }} - {{ date("d/m/Y", strtotime($taskData->todate)) }}</li>
                                                <li><b>Trạng thái:</b>
                                                    @if($taskData->status == 0 || $taskData->status == 3 || $taskData->status > 4)
                                                        <b style="color: green;"> {{ $statusTask['0'] }}</b>
                                                    @elseif($taskData->status == 1)
                                                        <b style="color: red;"> {{ $statusTask['1'] }}</b>
                                                    @elseif($taskData->status == 4)
                                                        <b style="color: red;"> {{ $statusTask['4'] }}</b>
                                                    @endif
                                                </li>
                                                <li><b>Người khởi tạo:</b> {{ $taskData->user()->first()->name }}</li>
                                            </ul>
                                        </div>
                						...
                						<div class="task-function">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('data_other_create', ['id' => $taskData->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                    @if($taskData->status == 0 || $taskData->status == 1 || Auth()->user()->roles()->first()->name == 'owner')
                                                        <li><a href="{{ route('data_others-edit', ['id' => $taskData->id]) }}" class="task-edit" data-title="Chỉnh sửa"><i class="fa fa-pencil-square-o"></i> Chỉnh sửa</a></li>
                                                        <li>
                                                            <a href="javascript:void(0)" data-id="{{ $taskData->id }}" class="btn-delete"><i class="fa fa-trash" aria-hidden="true"></i> {{ trans('home.Xóa') }}</a>
                                                            <form name="form-delete-{{ $taskData->id }}" method="post" action="{{ route('task-delete', ['id'=> $taskData->id]) }}">
                                                                {{ csrf_field() }}
                                                                {{ method_field('delete') }}
                                                            </form>
                                                        </li>
                                    ...
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskData->taskname }}">
                                            ...
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskData->status == 3 || $taskData->status > 5)
                                                    <span class="alert-success"> Đã duyệt</span>
                                                @elseif($taskData->status == 0)
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Trạng thái:</b>
                                                    ...
                                                    @elseif($taskData->status == 1)
                                                        <b style="color: red;"> {{ $statusTask['1'] }}</b>
                                                    @elseif($taskData->status == 3 || $taskData->status > 5)
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('data_other_leadapprove', ['id' => $taskData->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                	...
                	<div class="task-manage-box">
                		<div class="box">
                			...
                			<div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 3) as $taskData)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskData->taskname }}">
                                            <div class="task-name-item"><b>{{ $taskData->taskname }}</b></div>
                                            <div class="task-name-item">
                                                ...
                                                @if($taskData->status > 5)
                                                    <span class="alert-success"> Đã duyệt</span>
                                                @elseif($taskData->status == 4 || $taskData->status == 1)
                                                    <span class="alert-danger"> Không duyệt</span>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('data_other_ceoapprove', ['id' => $taskData->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                	...
                	<div class="task-manage-box">
                		<div class="box">
                			...
                			<div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 6) as $taskData)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskData->taskname }}">
                                            <div class="task-name-item"><b>{{ $taskData->taskname }}</b></div>
                                            <div class="task-name-item">
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskData->fromdate)) }} - {{ date("d/m/Y", strtotime($taskData->todate)) }}</li>
                                                <br>
                                                @foreach($taskData->detailTasks()->get()->where('status', '>=', 6) as $detailTask)
                                                <li><b>Công việc:</b>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('data_other_leadassign', ['id' => $taskData->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                	...
                	<div class="task-manage-box">
                		<div class="box">
                            ...
                            <div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 8) as $taskData)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskData->taskname }}">
                                            <div class="task-name-item"><b>{{ $taskData->taskname }}</b></div>
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskData->detailTasks()->get()->where('status', '>=', 11)->count() == $taskData->detailTasks()->get()->count())
                                                    <span class="alert-success"> Hoàn thành</span>
                                                @else
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskData->fromdate)) }} - {{ date("d/m/Y", strtotime($taskData->todate)) }}</li>
                                                <br>
                                                @foreach($taskData->detailTasks()->get()->where('status', '>=', 8) as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('data_user_receive', ['id' => $taskData->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                	...
                	<div class="task-manage-box">
                		<div class="box">
                			...
                			<div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 11) as $taskData)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskData->taskname }}">
                                            <div class="task-name-item"><b>{{ $taskData->taskname }}</b></div>
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskData->detailTasks()->get()->where('status', '>=', 14)->count() == $taskData->detailTasks()->get()->count())
                                                    <span class="alert-success"> Hoàn thành</span>
                                                @else
                                                    <span class="alert-info"> Đang làm</span>
                                                @endif
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskData->fromdate)) }} - {{ date("d/m/Y", strtotime($taskData->todate)) }}</li>
                                                <br>
                                                @foreach($taskData->detailTasks()->get()->where('status', '>=', 11) as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('data_user_report', ['id' => $taskData->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                	...
                	<div class="task-manage-box">
                		<div class="box">
                			...
                			<div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 13) as $taskData)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskData->taskname }}">
                                            <div class="task-name-item"><b>{{ $taskData->taskname }}</b></div>
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskData->detailTasks()->get()->where('status', '>=', 15)->count() == $taskData->detailTasks()->get()->count())
                                                    <span class="alert-success"> Hoàn thành</span>
                                                @else
                                                    <span class="alert-info"> Đang làm</span>
                                                @endif
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskData->fromdate)) }} - {{ date("d/m/Y", strtotime($taskData->todate)) }}</li>
                                                <br>
                                                @foreach($taskData->detailTasks()->get()->where('status', '>=', 13) as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('data_lead_approve', ['id' => $taskData->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                	...
                	<div class="task-manage-box">
                		<div class="box">
                			...
                			<div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 15 ) as $taskData)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskData->taskname }}">
                                            <div class="task-name-item"><b>{{ $taskData->taskname }}</b></div>
                                            <div class="task-name-item">
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskData->fromdate)) }} - {{ date("d/m/Y", strtotime($taskData->todate)) }}</li>
                                                <br>
                                                @foreach($taskData->detailTasks()->get()->where('status', '>=', 17) as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('data_ceo_approve_report', ['id' => $taskData->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskData->taskname }}">
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskData->fromdate)) }} - {{ date("d/m/Y", strtotime($taskData->todate)) }}</li>
                                                <br>
                                                @foreach($taskData->detailTasks()->get()->where('status', '>=', 21) as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
...
@include('task-manage.taskothers.data.add')
@endsection
