...
<div class="row">
    <form role="form" action="{{ route('task-update', ['id' => $taskContent->id]) }}?taskupdate=true" method="post" id="content_others-form">
        {{ csrf_field() }}
        {{ method_field('put') }}
        ...
        <div class="col-md-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <a href="{{ route('content_others-index') }}" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
                </div>
            </div>
        </div>
    </form>
...
<script>
    $(function() {
        $('.btn-save').click(function() {
            $('#content_others-form').submit();
        });

        $('#chk-continue').on('ifChecked', function() {
            $('#content_others-form').attr('action', '');
        });
