                					...
                					<div class="task-items clearfix">
                						<div class="task-name" title="{{ $taskMkt->taskname }}">
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskMkt->fromdate)) }} - {{ date("d/m/Y", strtotime($taskMkt->todate)) }}</li>
                                                <li><b>Trạng thái:</b>
                                                    @if($taskMkt->status == 0 || $taskMkt->status == 3 || $taskMkt->status > 4)
                						...
                						<div class="task-function">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('mkt_other_create', ['id' => $taskMkt->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                    @if($taskMkt->status == 0 || $taskMkt->status == 1 || Auth()->user()->roles()->first()->name == 'owner') 
                                                        <li><a href="{{ route('mkt_others-edit', ['id' => $taskMkt->id]) }}" class="task-edit" data-title="Chỉnh sửa"><i class="fa fa-pencil-square-o"></i> Chỉnh sửa</a></li>
                                                        <li>
                                    ...
                                    <div class="task-items clearfix">
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('mkt_other_leadapprove', ['id' => $taskMkt->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="task-items clearfix">
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('mkt_other_ceoapprove', ['id' => $taskMkt->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="task-items clearfix">
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('mkt_other_leadassign', ['id' => $taskMkt->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskMkt->taskname }}">
                                            ...
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskMkt->detailTasks()->get()->where('status', '>=', 11)->count() == $taskMkt->detailTasks()->get()->count())
                                                    <span class="alert-success"> Hoàn thành</span>
                                                @else
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('mkt_user_receive', ['id' => $taskMkt->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                	...
                	<div class="task-manage-box">
                		<div class="box">
                			...
                			<div class="box-body">
                                ...
                                @endif
                                @foreach($collections->where('status', '>=', 11) as $taskMkt)
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskMkt->taskname }}">
                                            <div class="task-name-item"><b>{{ $taskMkt->taskname }}</b></div>
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskMkt->detailTasks()->get()->where('status', '>=', 14)->count() == $taskMkt->detailTasks()->get()->count())
                                                    <span class="alert-success"> Hoàn thành</span>
                                                @else
                                                    <span class="alert-info"> Đang làm</span>
                                                @endif
                                            ...
                                            <ul class="task-name-detail">
                                                ...
                                                <li><b>Thời gian:</b> {{ date("d/m/Y", strtotime($taskMkt->fromdate)) }} - {{ date("d/m/Y", strtotime($taskMkt->todate)) }}</li>
                                                <br>
                                                @foreach($taskMkt->detailTasks()->get()->where('status', '>=', 11) as $detailTask)
                                                <li><b>Công việc:</b>
                                                    {{$detailTask->detailtaskname}}<br>  
                                                <b>Người thực hiện:</b>
                                                    {{$detailTask->employee()->first()->fullname}}<br>
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('mkt_user_report', ['id' => $taskMkt->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="task-items clearfix">
                                        <div class="task-name" title="{{ $taskMkt->taskname }}">
                                            ...
                                            <div class="task-name-item">
                                                ...
                                                @endif
                                                &nbsp;
                                                @if($taskMkt->detailTasks()->get()->where('status', '>=', 15)->count() == $taskMkt->detailTasks()->get()->count())
                                                    <span class="alert-success"> Hoàn thành</span>
                                                @else
                                                    <span class="alert-info"> Đang làm</span>
                                                @endif
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('mkt_lead_approve', ['id' => $taskMkt->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="task-items clearfix">
                                        ...
                                        <div class="task-function">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('mkt_ceo_approve_report', ['id' => $taskMkt->id]) }}" class="task-detail" data-title="Chi tiết"><i class="fa fa-info-circle"></i> Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
...
@include('task-manage.taskothers.marketing.add')
@endsection
