...
<div class="row">
    <div class="col-md-8">
        <div class="box box-primary">
            ...
            <form role="form" action="{{ route('laborcontracts-update', ['id' => $model->id]) }}?continue=false" method="post" id="frm">
                {{ csrf_field() }}
                {{ method_field('put') }}
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" tabindex="4" name="active" value="1" id="chk-active" {{ $model->active==1 ? 'checked="checked"' : '' }}> <br>(<font size='1'><u>{{ trans('home.Ghi chú') }}:</u> {{ trans('home.chỉ có 1 loại HĐLĐ được kích hoạt ở cùng thời điểm') }}.</font>)
                    </div>                    
                </div>
            </form>
        </div>
