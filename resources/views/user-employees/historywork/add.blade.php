...
<div class="row">
    <div class="col-md-8">
        <div class="box box-primary">
            ...
            <form role="form" action="{{ route('historyworks-store') }}?index=true" method="post" id="frm">
                {{ csrf_field() }}
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nummonths" value="{{ old('nummonths') }}">
