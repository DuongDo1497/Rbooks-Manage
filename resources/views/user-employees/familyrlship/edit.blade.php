...
<div class="row">
    <div class="col-md-8">
        <div class="box box-primary">
            ...
            <form role="form" action="{{ route('familyrlships-update', ['id' => $model->id]) }}?continue=false" method="post" id="frm">
                {{ csrf_field() }}
                {{ method_field('put') }}
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="work" value="{{ $model->work }}">
                    </div>                     
                </div>
            </form>
        </div>
