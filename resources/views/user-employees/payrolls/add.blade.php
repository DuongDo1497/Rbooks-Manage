...
<div class="row">
    <div class="col-md-8">
        <div class="box box-primary">
            ...
            <form role="form" action="{{ route('payrolls-store') }}?index=true" method="post" id="frm">
                {{ csrf_field() }}
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="worksalary" onkeyup='this.value=formatNumberDecimal(this.value)' value="{{ old('worksalary') }}">
                            @if($errors->has('worksalary'))<span class="text-danger">{{ $errors->first('worksalary') }}</span>@endif
                        </div>
                        <div class="form-group col-md-6">
                            <label>{{ trans('home.Phụ cấp') }}: </label>
                            <input type="text" class="form-control" name="extrasalary" onkeyup='this.value=formatNumberDecimal(this.value)' value="{{ old('extrasalary') }}">
                        </div>
                    </div>
