...
<div class="row">
    <div class="col-md-8">
        <div class="box box-primary">
            ...
            <form role="form" action="{{ route('disciplines-store') }}?index=true" method="post" id="frm">
                {{ csrf_field() }}
                <input type="hidden" name="employeeid"  value="{{ $employeeid }}">                
                <div class="box-body">
                    <div class="form-group">
                        <label>{{ trans('home.Ngày quyết định') }} <small class="text-danger text"> (*)</small>: </label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="disciplinenumber" value="{{ old('disciplinenumber') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="contentdiscipline" value="{{ old('contentdiscipline') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="formdiscipline" value="{{ old('formdiscipline') }}">
                    </div>                      
                    <div class="form-group">
